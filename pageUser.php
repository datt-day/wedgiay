        ...
        <div class="row mt-3" style="min-height: 300px;">
            ...
            <div class="col-lg-9">
                ...
                <div class="tab-content">
                            ...
                            <table class="table text-center w-100">
                                ...
                                while ($row = mysqli_fetch_assoc($listUser)){ ?>
                                    <tr>
                                        ...
                                        <td><a class="text-danger" href="index.php?task=deleteuser&iduser=<?php echo $row['id_user'] ?>">Xóa</a></td>
                                        <td><a class="text-danger" href="index.php?task=addUser&iduser=<?php echo $row['id_user'] ?>">Thêm</a></td>
                    ...
                    <a class="text-danger" href="index.php?task=addUser">Thêm</a>
